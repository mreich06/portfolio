...
const DesktopHero = (): JSX.Element => {
	return (
		<div className="hidden md:flex justify-center items-center px-6 md:px-8 lg:px-12 header-container relative">
			<div className="absolute w-[1000px] h-[600px] bg-green-400 opacity-18 blur-[230px] rounded-full z-0 top-[-10%] left-[-10%]" />
			<div className="w-full max-w-[1800px] flex gap-8 relative z-10">
