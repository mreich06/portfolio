...
const DesktopHero = (): JSX.Element => {
	return (
		<div className="hidden md:flex justify-center items-center px-6 md:px-8 lg:px-18 header-container relative my-20">
			...
			<div className="w-full max-w-[1800px] flex gap-8 relative z-10">
				...
				<div className="flex-1 flex justify-center items-center">
					<img
						src={ProfilePic}
						className="rounded-full border-6 border-sky-400 max-w-[400px] md:max-w-[500px] w-full h-auto"
						alt="Profile picture"
					/>
				</div>
			</div>
